...
errors=[]
required_files={
    'benchmark/src/main/java/com/msa/professionalmap/benchmark/BaselineProfileGenerator.kt': ['BaselineProfileRule', 'includeInStartupProfile = true', 'startActivityAndWait()'],
    'benchmark/src/main/java/com/msa/professionalmap/benchmark/StartupBenchmark.kt': ['MacrobenchmarkRule', 'CompilationMode.None()', 'BaselineProfileMode.Require'],
